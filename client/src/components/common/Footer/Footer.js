        ...
        <div className="footer-center">
          <div className="footer-center__contact">
            ...
            <p>
              ...
              libero quo sit impedit explicabo, voluptates magnam earum,
              inventore vero eligendi quod laborum odio nobis consequuntur ex
              repellendus tempore distinctio ab?
            </p>
            <ul>
              <li>
